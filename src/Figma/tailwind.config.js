    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                'premium-blue': 'rgb(var(--color-premium-blue) / <alpha-value>)',
                'premium-mist': 'rgb(var(--color-premium-mist) / <alpha-value>)',
                'pop-pink': 'rgb(var(--color-pop-pink) / <alpha-value>)',
                'pop-blush': 'rgb(var(--color-pop-blush) / <alpha-value>)',
                luxury: 'rgb(var(--color-luxury) / <alpha-value>)',
                'hero-luxury-ink': 'rgb(var(--color-hero-luxury-ink) / <alpha-value>)',
            ...
            gridTemplateColumns: {
                'mega-menu': '220px 1fr',
                'section-head': '1fr auto',
                'section-head-wide': '1fr auto 1fr'
            },
            gridTemplateRows: {
                'hero-card': '3fr 1fr'
            },
            ...
            gridAutoColumns: {
                'hero-mobile': '90%',
                'hero-tablet': 'calc((100% - 1rem) / 2.2)',
                'hero-desktop': 'calc((100% - 3rem) / 3.5)',
                'brand-mobile': '78vw',
                'brand-tablet': '280px',
                'brand-desktop': '252px'
            },
