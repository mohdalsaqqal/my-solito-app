...
export default function PharmacistNewTestPage() {
  ...
  return (
    ...
    >
      <Card variant='flat' style={{ gap: spacing['12'] }}>
        ...
        >
          <Text variant='title'>Consultation Form</Text>
        ...
        <Input value={summaryValue} onChangeText={setSummaryValue} placeholder='Test result summary' />
        ...
        <Text variant='title'>Recommendations & Stock</Text>
        <Box
          style={{
            flexDirection: isCompact ? 'column' : 'row',
            gap: spacing['8'],
        ...
        >
          <Box style={{ flex: 1, minWidth: spacing['128'] }}>
            <Input
              ...
              placeholder='Live search products by name or brand'
            />
          </Box>
        ...
        {productResults.length === 0 ? (
          ...
          <Box style={{ gap: spacing['8'] }}>
            {productResults.map((product, index) => {
              ...
              return (
                <Touchable key={productKey} onPress={() => toggleProduct(productKey)}>
