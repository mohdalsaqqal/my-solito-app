              ...
              items: [
                {
                  ...
                  answerEn: 'Standard shipping takes 3-5 business days. Express shipping delivers within 1-2 business days for major cities. You will receive a tracking number once your order ships.',
                  answerAr: 'يستغرق الشحن القياسي 3-5 أيام عمل. التوصيل السريع يصل خلال 1-2 يوم عمل للمدن الرئيسية. ستتلقى رقم تتبع بمجرد شحن طلبك.',
                },
                {
                  id: 'faq-returns',
                  questionEn: 'What is your return policy?',
                  questionAr: 'ما هي سياسة الإرجاع؟',
                  answerEn: 'You can return unopened products within 14 days of delivery for a full refund. Opened or used products cannot be returned for hygiene reasons. Contact our support team to initiate a return.',
                  answerAr: 'يمكنك إرجاع المنتجات غير المفتوحة خلال 14 يوماً من التسليم لاسترداد كامل المبلغ. لا يمكن إرجاع المنتجات المفتوحة أو المستخدمة لأسباب تتعلق بالنظافة. اتصل بفريق الدعم لبدء عملية الإرجاع.',
                },
                {
                  id: 'faq-authenticity',
                  questionEn: 'Are your products authentic?',
                  questionAr: 'هل منتجاتكم أصلية؟',
                  answerEn: 'Yes, all products sold on REAL Cosmetics are 100% authentic. We source directly from brands and authorized distributors. Each product comes with a authenticity guarantee.',
                  answerAr: 'نعم، جميع المنتجات المباعة على ريال كوزمتكس أصلية 100٪. نستورد مباشرة من العلامات التجارية والموزعين المعتمدين. يأتي كل منتج مع ضمان الأصالة.',
                },
                {
                  id: 'faq-loyalty',
                  questionEn: 'How does the loyalty program work?',
                  questionAr: 'كيف يعمل برنامج الولاء؟',
                  answerEn: 'Earn 1 point for every SAR 1 spent. Redeem points for discounts on future orders — 100 points = SAR 10 off. Points never expire as long as your account is active.',
                  answerAr: 'اكسب نقطة واحدة لكل ريال سعودي تنفقه. استبدل النقاط بخصومات على الطلبات المستقبلية — 100 نقطة = خصم 10 ريال. النقاط لا تنتهي صلاحيتها طالما حسابك نشط.',
                },
              ],
            },
          ],
